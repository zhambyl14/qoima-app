...
class _MakeSaleScreenState extends State<MakeSaleScreen> {
  ...
  Future<void> _goToStep2() async {
    ...
    for (final id in _selectedIds) {
      ...
      if (whBatches.isEmpty) { noStock.add(prod.name); continue; }
...
class _WhPickerSheet extends StatelessWidget {
  ...
  const _WhPickerSheet({required this.warehouses, required this.currentId,
    ...
    return Padding(
      ...
      child: Column(mainAxisSize: MainAxisSize.min, children: [
        ...
        ...warehouses.map((wh) => ListTile(
          ...
          title: Text(wh.name, style: const TextStyle(fontWeight: FontWeight.w600)),
...
class _Step1 extends StatefulWidget {
  ...
  const _Step1({required this.productStream, required this.selectedIds,
                ...
                child: Row(children: [
                  ...
                  ClipRRect(
                    ...
                    child: p.images.isNotEmpty
                        ? Image.network(p.images.first, width: 46, height: 46,
                            fit: BoxFit.cover,
    ...
    return Container(
      ...
      decoration: BoxDecoration(color: Colors.white,
          ...
          boxShadow: [
            ...
            BoxShadow(color: AppTheme.primary.withValues(alpha: 0.03),
          ...
          Row(children: [
            ClipRRect(
              ...
              child: item.product.images.isNotEmpty
                  ? Image.network(item.product.images.first, width: 42, height: 42,
                      fit: BoxFit.cover,
            ...
            child: Container(
              ...
              child: Row(children: [
                Icon(Icons.discount_outlined,
                    size: 16,
                    color: item.discountPercent > 0
                        ? AppTheme.warning : AppTheme.textHint),
                const SizedBox(width: 8),
                Expanded(child: item.discountPercent > 0
      ...
      child: Row(mainAxisSize: MainAxisSize.min, children: [
        GestureDetector(
          ...
          child: Container(
            width: 28, height: 28,
            decoration: BoxDecoration(
                color: cartQty > 0 ? AppTheme.danger.withValues(alpha: 0.8) : Colors.grey.shade100,
      ...
      child: Column(mainAxisSize: MainAxisSize.min, children: [
        ...
        SizedBox(
          ...
          child: ElevatedButton(
            ...
            style: ElevatedButton.styleFrom(
              backgroundColor: step == 1 ? AppTheme.success : AppTheme.primary,
