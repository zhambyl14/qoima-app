              ...
              child: SafeArea(bottom: false, child: Padding(
                ...
                child: Row(children: [
                  ...
                  const Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    Text('Қоймалар', style: TextStyle(color: Colors.white, fontSize: 20,
            ...
            if (warehouses.isEmpty)
              SliverFillRemaining(child: Center(
                child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                  ...
                  const Text('Қойма жоқ', style: TextStyle(
              ...
              SliverPadding(
                ...
                sliver: SliverList(
                  delegate: SliverChildBuilderDelegate(
                    (_, i) => _WarehouseCard(wh: warehouses[i], service: service),
      ...
      child: ListTile(
        ...
        leading: Container(
          ...
          child: Icon(Icons.warehouse_rounded,
              color: wh.isMain ? AppTheme.primary : AppTheme.textHint, size: 22)),
        title: Row(children: [
          Text(wh.name, style: const TextStyle(fontWeight: FontWeight.w600,
          ...
          if (wh.isMain) ...[
            ...
            Container(
              ...
              child: const Text('НЕГ.', style: TextStyle(
                  color: Colors.white, fontSize: 9, fontWeight: FontWeight.w700))),
          ],
        ]),
        subtitle: wh.address != null && wh.address!.isNotEmpty
            ? Text(wh.address!, style: const TextStyle(
...
class _AddWarehouseSheetState extends State<_AddWarehouseSheet> {
  ...
  @override
  void dispose() {
    _nameCtrl.dispose(); _addressCtrl.dispose(); _noteCtrl.dispose();
    super.dispose();
  }
