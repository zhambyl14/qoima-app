                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      Text(
                          user.isSeller
                              ? tr('Доступ к магазину приостановлен',
                                  'Дүкенге доступ тоқтатылды')
                              : tr('Доступ временно приостановлен',
                                  'Доступ уақытша тоқтатылды'),
                          style: manrope(15, FontWeight.w800,
                              color: Colors.white)),
                      const SizedBox(height: 2),
                      Text(
                          untilStr.isEmpty
                              ? tr('Товары доступны только для просмотра. Обратитесь к администрации маркетплейса.',
                                  'Тауарлар тек қарау үшін. Маркетплейс әкімшілігіне хабарласыңыз.')
                              : tr('С $untilStr товары доступны только для просмотра. Обратитесь к администрации маркетплейса.',
                                  '$untilStr бастап тауарлар тек қарау үшін. Маркетплейс әкімшілігіне хабарласыңыз.'),
          ...
          child: Column(mainAxisSize: MainAxisSize.min, children: [
            ...
            Text(
              context.read<AppUser>().isSeller
                  ? tr('Доступ к магазину скоро будет ограничен',
                      'Дүкенге доступ жақында шектеледі')
                  : tr('Доступ скоро будет ограничен',
                      'Доступ жақында шектеледі'),
            ...
            Text(
              freezeIn > 0
                  ? tr('Через $freezeIn дн. доступ будет ограничен: товары останутся только для просмотра.',
                      '$freezeIn күннен кейін доступ шектеледі: тауарлар тек қарауға қалады.')
                  : tr('Доступ будет ограничен сегодня: товары останутся только для просмотра.',
                      'Доступ бүгін шектеледі: тауарлар тек қарауға қалады.'),
              textAlign: TextAlign.center,
              style: manrope(13.5, FontWeight.w500, color: cInk2, height: 1.45),
            ),
            const SizedBox(height: 6),
            Text(
              tr('По вопросам обратитесь к администрации маркетплейса.',
                  'Сұрақтар бойынша маркетплейс әкімшілігіне хабарласыңыз.'),
              textAlign: TextAlign.center,
