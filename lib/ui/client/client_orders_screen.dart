...
class ClientOrdersScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: phone.isEmpty
          ? const Center(child: Text('Телефон нөмірі жоқ',
...
class _OrderCardState extends State<_OrderCard> {
  ...
  Color get _statusColor {
    switch (widget.order.status) {
      case OrderModel.statusReserved:  return const Color(0xFF3B82F6);
      case OrderModel.statusPending:   return AppTheme.warning;
      case OrderModel.statusConfirmed: return AppTheme.primary;
      case OrderModel.statusReady:     return AppTheme.success;
  ...
  String get _statusLabel {
    switch (widget.order.status) {
      case OrderModel.statusReserved:  return 'Брондалды';
      case OrderModel.statusPending:   return 'Күтуде';
      case OrderModel.statusConfirmed: return 'Расталды';
      case OrderModel.statusReady:     return 'Дайын';
      case OrderModel.statusCompleted: return 'Аяқталды';
      case OrderModel.statusCancelled: return 'Бас тартылды';
  ...
  String get _typeLabel {
    switch (widget.order.orderType) {
      ...
      default:                              return widget.order.orderType;
    }
  }
    ...
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        ...order.items.map((item) => Padding(
          ...
          child: Row(children: [
            Expanded(child: Text('${item.productName}  (${item.size})',
        ...
        if (order.isSmartReservation) ...[
          ...
          _PayRow('Төленген депозит',
              '${order.depositAmount.toStringAsFixed(0)} ₸',
              color: const Color(0xFF3B82F6)),
          _PayRow('Дүкенде қалады',
          ...
          _PayRow('Барлығы',
              '${order.totalWithDelivery.toStringAsFixed(0)} ₸',
              bold: true),
        ] else
