...
class _ClientOrderSuccessScreenState extends State<ClientOrderSuccessScreen> {
  ...
  Widget build(BuildContext context) {
    final code = o.pickupCode.isNotEmpty ? o.pickupCode : o.id.substring(0, 8).toUpperCase();
            ...
            Container(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                Row(children: [
                  ...
                  Expanded(child: Text(o.storeName,
          ...
          Container(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              if (o.isSmartReservation) ...[
                ...
                if (o.deliveryFee > 0)
                  _SummaryRow('Доставка', '${o.deliveryFee.toStringAsFixed(0)} ₸'),
