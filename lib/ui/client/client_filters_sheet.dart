...
class _ClientFiltersSheetState extends State<ClientFiltersSheet> {
  ...
  int get _resultCount {
    return widget.pairs.where((pair) {
      ...
      if (_f.categories.isNotEmpty && !_f.categories.contains(p.category)) return false;
      if (_f.sizes.isNotEmpty) {
        final has = b.any((bt) =>
            _f.sizes.any((s) => bt.availableSizes.containsKey(s)));
        if (!has) return false;
      }
              ...
              children: [
                ...
                if (_allTypes.isNotEmpty) ...[
                  ...
                  Wrap(spacing: 8, runSpacing: 8,
                    children: _sortedList(_allTypes).map((v) => _OptionChip(
                      label: v,
                ...
                if (_allBrands.isNotEmpty) ...[
                  ...
                  const SizedBox(height: 8),
                  Wrap(spacing: 8, runSpacing: 8,
                    children: _sortedList(_allBrands).map((v) => _OptionChip(
                      label: v,
                ...
                if (_allSizes.isNotEmpty) ...[
                  ...
                  const SizedBox(height: 8),
                  Wrap(spacing: 8, runSpacing: 8,
                    children: _sortedSizes(_allSizes).map((v) => _SizeChip(
                      label: v,
                ...
                if (_allColors.isNotEmpty) ...[
                  ...
                  const SizedBox(height: 8),
                  Wrap(spacing: 8, runSpacing: 8,
                    children: _sortedList(_allColors).map((v) => _OptionChip(
                      label: v,
                ...
                if (_allCategories.isNotEmpty) ...[
                  ...
                  const SizedBox(height: 8),
                  Wrap(spacing: 8, runSpacing: 8,
                    children: _sortedList(_allCategories).map((v) => _OptionChip(
                      label: v,
...
class _PriceField extends StatefulWidget {
  ...
  const _PriceField({required this.hint, this.initial, required this.onChanged});
