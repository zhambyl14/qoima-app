...
class _DetailBody extends StatefulWidget {
  final ReturnModel ret;
  const _DetailBody({required this.ret});
...
class _DetailBodyState extends State<_DetailBody> {
  ...
  Future<void> _approve() async {
    ...
    try {
      await ReturnService()
          .approveReturn(r.adminUid, r.id, AppUser.current.uid);
      if (mounted) {
      ...
      body: Column(children: [
        ...
        Expanded(
          child: ListView(
            ...
            children: [
              // Client section
              _SectionHeader(context.l10n.returnClientSection),
              QCard(
              ...
              // Source order/sale
              if (r.orderId != null || r.saleId != null) ...[
                _SectionHeader(context.l10n.returnSourceSection),
                QCard(
                  padding: const EdgeInsets.all(14),
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
              ...
              // Items
              _SectionHeader(context.l10n.returnItemsSection),
              ...
              // Reason
              const SizedBox(height: 14),
              _SectionHeader(context.l10n.returnReasonLabel),
              QCard(
                padding: const EdgeInsets.all(14),
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    ...
                    if (r.reasonNote != null && r.reasonNote!.isNotEmpty) ...[
              ...
              if (r.photoUrls.isNotEmpty) ...[
                const SizedBox(height: 14),
                _SectionHeader(context.l10n.returnPhotosLabel),
                SizedBox(
                  height: 90,
              ...
              if (r.conditionPhotos.isNotEmpty) ...[
                ...
                SizedBox(
                  ...
                  child: ListView.separated(
                    scrollDirection: Axis.horizontal,
                    itemCount: r.conditionPhotos.length,
                    separatorBuilder: (_, __) => const SizedBox(width: 8),
                    itemBuilder: (_, i) => ClipRRect(
                      borderRadius: BorderRadius.circular(10),
                      child: Image.network(r.conditionPhotos[i],
                          width: 90, height: 90, fit: BoxFit.cover),
                    ),
                  ),
                ),
              ...
              // Timeline
              const SizedBox(height: 14),
              _SectionHeader(context.l10n.returnTimelineTitle),
              _Timeline(ret: r),
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(color: cGreen.withValues(alpha: 0.2)),
                ),
                child: Row(
                ...
                Row(children: [
                  Expanded(
                    child: OutlinedButton(
                      ...
                      child: Text(context.l10n.returnReject,
                          style:
                              manrope(14, FontWeight.w700, color: cRed)),
                    ),
                  ),
                  const SizedBox(width: 12),
                  Expanded(
              ...
              // Approved/received: тығырықтан шығу үшін бас тарту мүмкіндігі
              // (мысалы, сатушы аяқтай алмай қалса, админ возвратты жаба алады).
  ...
  Widget build(BuildContext context) {
    final steps = <({String label, DateTime? at, bool done})>[
      ...
      (
        ...
        at: ret.receivedAt,
        done: ret.receivedAt != null || ret.status == ReturnStatus.refunded,
      ),
      (
...
class _ProductIconPlaceholder extends StatelessWidget {
  @override
